    ...
    public Order create(Order order) {
        ...
        jdbcTemplate.update(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection connection)
                    throws SQLException {
                PreparedStatement ps = connection.prepareStatement("INSERT INTO `order` (type, status, workers, hours, address, latitude, longitude, cost, paymentType, oderDate, userId) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);", Statement.RETURN_GENERATED_KEYS);
